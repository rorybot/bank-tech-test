describe Printer do
  ...
  let(:test_account) do
    dummy_transaction = [{ type: 'deposit', amount: 1000, date: Time.new(2012, 01, 10) }, { type: 'deposit', amount: 2000, date: Time.new(2012, 01, 13) }, { type: 'withdraw', amount: 500, date: Time.new(2012, 01, 14) }]
